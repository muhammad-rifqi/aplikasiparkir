      ...
      <div class="page-404 animated flipInX"> 
		<div id="print-karcis" class="print-area" style="color : #2280c2;">
        	...
        	<h2 style="font-weight:bold; color: #f36f5b ;margin-top: -4px;">Kode Parkir Anda</h2>
          	<p style="font-size: 70pt; font-weight: bold; color: #029688; margin-top: -10px;"><?php echo '<img src="data:image/png;base64,' . base64_encode($generator->getBarcode($data['kode'], $generator::TYPE_CODE_128)) . '">'; ?></p>
