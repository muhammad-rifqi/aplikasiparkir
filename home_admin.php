...
<body class="dashboard topnav">
	<!-- start: Header -->
        <nav class="navbar navbar-default header navbar-fixed-top bg-primary">
	...
	<div id="content">
		...
		<div class="col-md-6" style="margin-top: 30px">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading bg-primary">
                      ...
                      <div class="col-md-12">
                        <form method="post">
                          <div class="col-md-12" style="margin-top: -30px;">
                            ...
                            <input class="submit btn btn-primary col-md-5 right" type="submit" style="height: 40px" value="Submit" name="btn_baru">
                          </div>
                      </form>
                    </div>
                  </div>
              ...
              <div class="col-md-12 col-sm-12 col-x-12" style="margin-top: 30px;">
                  <div class="col-md-12 panel">
                    ...
                    <div class="panel-body">
                    <div class="table-responsive col-md-12 col-sm-12 col-xs-12">
                    <input class="submit btn btn-primary col-md-2" type="submit" style="height: 40px;margin-top: 20px;" value="Delete All" onclick="return confirm('Apakah Anda Yakin Menghapus Semuanya?')" name="btn_delete">
