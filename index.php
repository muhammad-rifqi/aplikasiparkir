...
<body class="bg-green" style="overflow-y: hidden;  background-image: url('asset/img/bg.jpg');background-repeat: no-repeat;background-size: cover;">
  	<div class="panel container col-lg-4 col-md-6 col-sm-6 col-xs-12" style="position: relative; margin: auto; box-shadow: 0 7px 16px #00655b, 0 4px 5px #006f64;">
          <div class="panel-body">
            ...
            <div style="float: left;">
              <h1 class="animated fadeInLeft" id="jam" style="margin-left: 20px; font-size: 60pt"><?//= $waktu ?></h1>
          ...
          <div class="col-md-12 panel-body" style="padding-bottom:400px;">
                        <div class="col-md-11">
                          <form class="cmxform" method="POST">
                              ...
                              <form class="cmxform" method="POST">
                              <input class="submit btn btn-primary col-md-5 col-sm-5 col-xs-12" style="margin-top: 10px; margin-left: 10px; height: 40px;" type="submit" value="Admin" name="signup">
							  <br><br><br><br>
								<center><p>copyright by <a href="#" title="" target="_blank">StokCoding.com</a></p></center>
                              </form>
