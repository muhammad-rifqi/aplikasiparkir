...
<body style="overflow-y: hidden; background-image: url('asset/img/bg.jpg');background-repeat: no-repeat;background-size: cover;" class="bg-primary">
	<div class="panel container col-lg-4 col-md-6 col-sm-8 col-xs-12" style="position: relative; margin: auto; box-shadow: 0 7px 16px #691816, 0 4px 5px #93211f;">
        <div class="panel-body">
          ...
          <div style="float: left;">
            <h1 class="animated fadeInLeft" id="jam" style="margin-left: 20px; font-size: 60pt"><?//php echo $waktu; ?></h1>
        ...
        <div class="col-md-12 panel-body" style="padding-bottom:400px;">
                       <div class="col-md-11">
                        <form class="cmxform" method="POST">
                            ...
                            <input class="submit btn btn-primary col-md-5 col-sm-5 col-xs-12" type="submit" value="Login Admin" name="login_admin" style="margin-top: 10px;margin-left: 10px; height: 40px;">
                        </form>
